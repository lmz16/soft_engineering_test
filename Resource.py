...
class RCharacter():
    def __init__(self,loadfile):
        with open (loadfile,'r') as Rcharacterfile:
            ...
            #↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓将静止、攻击、行动、被攻击都修改成三个图像。图像的接口还需要调整
            ...
            self.pic_static2=pygame.transform.smoothscale(
                pygame.image.load(playerinfo[0][1]).convert_alpha(),playerinfo[1])##############此处修改图片
            self.pic_static3=pygame.transform.smoothscale(
                pygame.image.load(playerinfo[0][2]).convert_alpha(),playerinfo[1])##############此处修改图片
            ...
            self.pic_move3=pygame.transform.smoothscale(
                pygame.image.load(playerinfo[0][4]).convert_alpha(),playerinfo[1])##############此处修改图片
            ...
            self.pic_attacked2=pygame.transform.smoothscale(
                pygame.image.load(playerinfo[0][0]).convert_alpha(),playerinfo[1])##############此处修改图片
